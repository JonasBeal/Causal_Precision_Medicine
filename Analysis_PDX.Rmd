---
title: "Precision medicine and causality - PDX"
author: "Jonas BÉAL"
date: "05/18/2020"
output:
  html_document:
...
![Causal diagram in Precision Medicine](Pictures/DAG_multiple.png)
...
tic()
PDX_clin_sens <- readxl::read_xlsx("Data/nm.3954-S2-modified.xlsx",
                                   sheet = 3) %>%
...
PDX_mut <- read_xlsx("Data/nm.3954-S2-modified.xlsx", sheet = 1) %>%
  filter(Sample %in% my_models) %>%
